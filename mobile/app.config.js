...
const appConfig = {
  expo: {
    ...
    version: "1.0.0",
    description:
      "AI 기반 톤 조정 앱으로 텍스트의 톤을 원하는 스타일로 변환해보세요.",
    ...
    appStore: {
      ...
      description:
        "ToneTuner는 AI 기술을 활용하여 텍스트의 톤을 다양한 스타일로 변환해주는 혁신적인 앱입니다. 공식적인 톤, 친근한 톤, 전문적인 톤 등 원하는 톤으로 텍스트를 재작성할 수 있습니다.",
    ...
    playStore: {
      ...
      fullDescription:
        "ToneTuner는 AI 기술을 활용하여 텍스트의 톤을 다양한 스타일로 변환해주는 혁신적인 앱입니다. 공식적인 톤, 친근한 톤, 전문적인 톤 등 원하는 톤으로 텍스트를 재작성할 수 있습니다. 작문, 이메일, 소셜미디어 포스트 등 다양한 상황에서 활용하세요.",
      category: "PRODUCTIVITY",
